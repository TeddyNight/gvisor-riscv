...
var linuxRISCV64 = SyscallMap{
	...
	422:  makeSyscallInfo("futex", Hex, FutexOp, Hex, Timespec, Hex, Hex),
	...
	408: makeSyscallInfo("timer_gettime", Hex, PostItimerSpec),
	109: makeSyscallInfo("timer_getoverrun", Hex),
	409: makeSyscallInfo("timer_settime", Hex, Hex, ItimerSpec, PostItimerSpec),
	111: makeSyscallInfo("timer_delete", Hex),
	404: makeSyscallInfo("clock_settime", Hex, Timespec),
	403: makeSyscallInfo("clock_gettime", Hex, PostTimespec),
	406: makeSyscallInfo("clock_getres", Hex, PostTimespec),
	407: makeSyscallInfo("clock_nanosleep", Hex, Hex, Timespec, PostTimespec),
	...
	418: makeSyscallInfo("mq_timedsend", Hex, Hex, Hex, Hex, Hex),
	419: makeSyscallInfo("mq_timedreceive", Hex, Hex, Hex, Hex, Hex),
	...
	420: makeSyscallInfo("semtimedop", Hex, Hex, Hex, Hex),
	...
	405: makeSyscallInfo("clock_adjtime", Hex, Hex),
